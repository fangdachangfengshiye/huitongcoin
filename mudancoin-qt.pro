...
contains(USE_UPNP, -) {
    ...
    MINIUPNPC_INCLUDE_PATH = ../deps/miniupnpc
...
OPENSSL_INCLUDE_PATH = ../deps/openssl-1.0.1g/include
OPENSSL_LIB_PATH = ../deps/openssl-1.0.1g
